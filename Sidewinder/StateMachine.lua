...
function StateMachine:change(stateName, enterParams, enterParams1, enterParams2, enterParams3)
	assert(self.states[stateName]) -- state must exist!
	self.current:exit()
	self.current = self.states[stateName]()
	self.current:enter(enterParams, enterParams1, enterParams2, enterParams3)
end
